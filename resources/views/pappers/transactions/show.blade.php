      ...
      <div class="col-md-6">
        ...
        <ul class="list-group push">
          ...
          <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span class="fw-semibold">{{ Format::formatRupiah($transaction->amount) }}</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            {{ trans('Tanggal Upload') }}
            <span class="fw-semibold">{{ Format::customDate($transaction->upload_date) . " | " . $transaction->created_at->format('H:i') }}</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        @if (me()->hasRole(Constant::ADMIN))
          <form action="{{ route('transactions.update', $transaction->uuid) }}" id="form-update" method="POST">
            @csrf
            @method('patch')
