      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <input type="date" name="date_start" id="date_start" value="{{ old('date_start', date('Y-m-d', strtotime($registration->date_start->toDateString()))) }}" class="form-control @error('date_start') is-invalid @enderror">
            @error('date_start')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="date" name="date_end" id="date_end" value="{{ old('date_end', date('Y-m-d', strtotime($registration->date_end->toDateString()))) }}" class="form-control @error('date_end') is-invalid @enderror">
            @error('date_end')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
