        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <div class="mb-4">
              ...
              <input type="text" name="first_title" id="first_title" value="{{ old('first_title') }}" class="form-control @error('first_title') is-invalid @enderror" placeholder="{{ trans('Input Gelar') }}" onkeypress="return hanyaHuruf(event)">
              @error('first_title')
            ...
            <div class="mb-4">
              ...
              <input type="text" name="last_title" id="last_title" value="{{ old('last_title') }}" class="form-control @error('last_title') is-invalid @enderror" placeholder="{{ trans('Input Gelar') }}" onkeypress="return hanyaHuruf(event)">
              @error('last_title')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="mb-4">
              <label for="roles" class="form-label">{{ trans('Peran') }}</label>
            ...
            <div class="mb-4">
              ...
              <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="{{ trans('Input Email') }}">
              @error('email')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="mb-4">
              ...
              <input type="text" name="institution" id="institution" value="{{ old('institution') }}" class="form-control @error('institution') is-invalid @enderror" placeholder="{{ trans('Input Institusi') }}">
              @error('institution')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
